...
export function Environment(name: string): BaseURL {
  return `https://${name}-booking-system-vsdi.encr.app`;
}
...
/**
 * Client is an API client for the booking-system-vsdi Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "booking-system-vsdi-Generated-TS-Client (Encore/v1.28.0)",
    };
